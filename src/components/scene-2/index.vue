<template>
  <div class="scene-2" ref="scene-2" onselectstart="return false;"></div>
</template>
  ...
  methods: {
    ...
    loadScene() {
      this.runScene = new RunScene({
        ...
        .load({
          path: "https://linktwins-1303915342.cos.ap-shanghai.myqcloud.com/weicai/scene-2.glb",
          dom: this.$refs["scene-2"],
        })
        .on("complete", () => {
          console.log("场景加载结束");
        });
