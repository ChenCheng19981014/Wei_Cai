<template>
  <div class="scene-4" ref="scene-4" onselectstart="return false;"></div>
</template>
  ...
  methods: {
    ...
    loadScene() {
      this.runScene = new RunScene({
        ...
        .load({
          path: "https://linktwins-1303915342.cos.ap-shanghai.myqcloud.com/weicai/scene-4.glb",
          dom: this.$refs["scene-4"],
        })
        .on("complete", () => {
          console.log("场景加载结束");
        });
